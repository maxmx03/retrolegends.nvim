-- retrolegends Colorscheme for neovim
...
if vim.g.retrolegends_cmp then
  ...
  vim.api.nvim_set_hl(
    ...
    { fg = '#ffd933', reverse = true }
  )
  vim.api.nvim_set_hl(
    0,
    'CmpItemKindMethod',
    { fg = '#4c80ff', reverse = true }
  )
  vim.api.nvim_set_hl(
    0,
    'CmpItemKindFunction',
